...
{
    public class ModelController : DefaultApiCRUDController<ModelSaveVM, ModelEditVM, ModelVM, ModelPaggingListVM, Model, IModelService>
    {
        public ModelController(IModelService service, APIResult apiResult)
